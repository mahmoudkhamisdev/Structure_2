...
export const IdentifyingRelNode = memo(function IdentifyingRelNode({
  ...
  return (
    <NodeContextMenu id={id} currentType="identifyingRelationship">
      <div
        className={cn(
          "group relative inline-flex items-center justify-center w-fit px-7 py-3 transition-colors duration-100 whitespace-nowrap",
      ...
      >
        ...
        <div className="relative z-10 text-[11.5px] font-medium tracking-tight text-card-foreground">
